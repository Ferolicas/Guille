  ...
  return (
    <main className="panel-auth-page">
      ...
      <section className="panel-auth-card">
        ...
        {mode === "login" ? (
          <>
            <div className="panel-auth-heading"><span><KeyRound size={18} /></span><p>Acceso privado</p><h1>Panel de trabajos</h1><small>Gestiona las seis tarjetas de la galería y revisa las solicitudes recibidas.</small></div>
