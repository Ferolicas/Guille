...
- Hero: `hero-guillo.png` sin degradado y con una capa negra uniforme al 20% para legibilidad; la primera pantalla queda cerrada por la franja de tres especialidades.
