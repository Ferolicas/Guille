...
- Hero: `hero-guillo.png` sin degradado y con una capa negra uniforme al 25% para legibilidad; la primera pantalla queda cerrada por la franja de tres especialidades.
...
- Galería: botones Fotos/Vídeos, dos tarjetas visibles en móvil, medios reales importados y slots manuales, snap horizontal, visor modal navegable para fotos y vídeos, y selector Antes/Después cuando corresponda.
- Modal de valoración: máximo dos pasos, sin scroll a 390×844; progreso naranja, errores inline y confirmación diseñada.
- Panel: navegación compacta en móvil y lateral en escritorio; eliminación individual de fotos y vídeos importados, seis editores independientes, solicitudes privadas y seguridad.
